SUBROUTINE CASPT2_UDLDET(PSI,F,NAO,NMO,CMO,ONEINT,TWOINT)
  ...
  ! exponential operator exp(Q). This version uses a determinant basis directly
  ! instead of a parameter exansion of excitation cases.
  ...
  INTEGER :: A, B, I, J, T, U, P, Q, R, S, IA, IB, JA, JB
  INTEGER, ALLOCATABLE :: ADET(:), BDET(:)
...
!#endif
  ...
  WRITE(*,'(A,I9)') '#SD determinants in Psi1 = ', NSD
